...
#include <fstream>
/*+
 * Quelle: Perlin, Ken. „Improved Noise reference implementation“. Zugegriffen 25. August 2025. https://cs.nyu.edu/~perlin/noise/.
 */

int Perlin::p[Perlin::PERM_SIZE * 2];
bool Perlin::initialized = false;
const int Perlin::permutation[PERM_SIZE] = { 
