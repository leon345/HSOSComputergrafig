...
public:
	...
	void outlineColor(const Color& c);
	...
	const Color& outlineColor() const { return OutlineColor; }
	float outlineWidth() const { return OutlineWidth; }
...
private:
    ...
    enum UPDATESTATES
    {
    	...
    	OUTLINE_COLOR_CHANGED = 1<<8,
		OUTLINE_WIDTH_CHANGED = 1<<9
    };
